...
- **Seismic wave simulation** — @moseley2020seismicgnn explored deep learning approaches for simulating seismic wave propagation on unstructured meshes, where graph-based representations naturally fit the mesh topology used in finite-element methods.
