...
Diffusion models are very new to the geosciences and the field does not yet have a single canonical reference. The closest pointers are the broader machine-learning-in-geoscience reviews @bergen2019mlgeo and @dramsch2020rnnseismic, which place generative modelling in context but predate most of the diffusion uptake. Expect dedicated geoscience-diffusion milestones in the next few years rather than today.