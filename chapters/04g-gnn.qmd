...
- **Global weather forecasting** — @lam2023graphcast (GraphCast) is the milestone graph-neural-network result for medium-range weather prediction, outperforming ECMWF's HRES operational system on most metrics while running orders of magnitude faster.
- **Hydrological networks** — @stanev2021gnnhydro applied GNNs to hydrological coherence analysis from remotely sensed water-level data, exploiting the natural graph structure of river networks and gauge connectivity.
