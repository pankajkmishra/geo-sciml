...
- **First-break refraction picking** — @mccormack1993firstbreak is one of the earliest applications of feedforward neural networks to seismic processing.
- **Petrophysical prediction from well logs** — @huang1996permeability established MLPs as a workhorse for permeability and porosity regression in rock physics.
- **Lithology classification from downhole logs** — @benaouda1999lithology is the canonical reference for MLP-based lithology inference.
- **Geoscience ML overview** — @bergen2019mlgeo and @reichstein2019deepgeo place MLPs in the wider context of machine learning across the Earth sciences.
